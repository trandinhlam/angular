	...
	it('should be created', inject([TodoDataService], (service: TodoDataService) => {
 	...
 	describe('#getAllTodos()', () => {
		...
		it('should return an empty array', inject([TodoDataService], (service: TodoDataService) =>{
	  	...
	  	it('should return an array', inject([TodoDataService], (service: TodoDataService) =>{
	  		let todo1 = new Todo({ title: 'Hello1'});
	  		let todo2 = new Todo({ title: 'Hello2'});
 	...
 	describe('#save(todo)', () => {
		...
		it('should return automatically assign an incrementing id', inject([TodoDataService], (service: TodoDataService) =>{
	  		let todo1 = new Todo({ title: 'Hello1'});
	  		let todo2 = new Todo({ title: 'Hello2'});
	  		service.addTodo(todo1);
	  		service.addTodo(todo2);
 	...
 	describe('#deleteTodoById(id)', () => {
		...
		it('should remove todo by corresponding id', inject([TodoDataService], (service: TodoDataService) =>{
	  		let todo1 = new Todo({ title: 'Hello1'});
	  		let todo2 = new Todo({ title: 'Hello2'});
	  		service.addTodo(todo1);
	  		service.addTodo(todo2);
	  	...
	  	it('should remove NOTHING if id doesn\'t exists', inject([TodoDataService], (service: TodoDataService) =>{
	  		let todo1 = new Todo({ title: 'Hello1'});
	  		let todo2 = new Todo({ title: 'Hello2'});
	  		service.addTodo(todo1);
	  		service.addTodo(todo2);
